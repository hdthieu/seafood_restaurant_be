...
import { IsDateString, IsEnum, IsNumber, IsOptional, IsString, IsUUID, Max, Min, ValidateIf } from 'class-validator';
...
export class CreatePurchaseReceiptItemDto {
  ...
  @Max(100, { message: 'Chiết khấu item phần trăm không được quá 100%' })
